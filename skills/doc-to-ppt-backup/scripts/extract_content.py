...
"""
Enhanced content extraction with summarize CLI integration.
Extracts and summarizes text from PDF, Word, PowerPoint, images, and URLs.

Usage:
  python extract_content.py <file_path> [--summarize] [--json]
  python extract_content.py <url> [--summarize] [--json]
  
Output: JSON with extracted text, summary, and metadata
"""
